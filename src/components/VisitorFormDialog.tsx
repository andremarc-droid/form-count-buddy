...
export function VisitorFormDialog({
    ...
    const addMutation = useAddVisitor();
            ...
            <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="dlg_full_name">Full Name *</Label>
                        <Input
                            id="dlg_full_name"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                            <Label htmlFor="dlg_age">Age *</Label>
                            <Input
                                id="dlg_age"
                                type="number"
                                placeholder="25"
                    ...
                    {(selectedIndustry === "private_sector" ||
                        selectedIndustry === "msme") && (
                            <div className="space-y-2">
                                <Label htmlFor="dlg_industry_location">Location</Label>
                                <Input
                                    id="dlg_industry_location"
                    ...
                    {selectedPurpose === "others" && (
                        <div className="space-y-2">
                            <Label htmlFor="dlg_purpose_detail">Please specify *</Label>
                            <Input
                                id="dlg_purpose_detail"
