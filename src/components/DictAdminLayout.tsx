    ...
    <div className="h-screen flex bg-background overflow-hidden relative">
      ...
      <aside className="hidden md:flex w-64 h-full bg-emerald-900 border-r border-emerald-800 flex-col shadow-2xl z-10 transition-all duration-300">
        ...
        <div className="px-2 pt-3 pb-1">
          <div className="flex border-b border-emerald-700">
            {TABS.map((t) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "flex-1 text-center pb-2 text-sm font-medium cursor-pointer transition-colors",
                    isActive
                      ? "text-emerald-50 border-b-2 border-blue-500"
        ...
        <hr className="border-emerald-800 mx-4" />
