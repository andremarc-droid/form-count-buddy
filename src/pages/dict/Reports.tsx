...
import type { DictVisitorRow } from "@/hooks/useDictVisitorData";
...
const DictReports = () => {
  ...
  const exportCSV = () => {
    ...
    a.href = url;
    a.download = `dict-visitors-report-${format(new Date(), "yyyy-MM-dd")}.csv`;
    a.click();
    ...
    <>
      <div className="page-header flex flex-col sm:flex-row sm:items-start justify-between gap-4">
        <div>
          ...
          <p className="page-subtitle">DICT Provincial Office — Generate and export visitor reports</p>
        </div>
...
function generatePDFContent(
  visitors: DictVisitorRow[],
  stats: ReturnType<typeof computeDictStats>,
  globalStats: ReturnType<typeof computeDictStats>,
  reportType: string
) {
  ...
  return `
    ...
    <html>
    <head>
      <title>DICT Provincial Office - Foot Traffic Report - ${reportDate}</title>
      <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .stat-card:nth-child(3)::before { background: #059669; }
        .stat-card:nth-child(4)::before { background: #047857; }
        .stat-value {
          font-size: 32px;
          font-weight: 700;
          color: #0f172a;
    ...
    <body>
      <div class="page">
        <div class="header">
          <h1>DICT Provincial Office Bukidnon — Foot Traffic Report</h1>
        ...
        <div class="footer">
          <span>DICT Provincial Office Bukidnon — Foot Traffic Monitor</span>
